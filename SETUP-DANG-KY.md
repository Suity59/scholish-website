...
| `SEPAY_BANK_ACC` | `04296754555` | Giống hệ `hoc.namanhsuit.com` |
| `SEPAY_BANK_NAME` | `TPBank` | Giống hệ `hoc.namanhsuit.com` |
| `SEPAY_BANK_OWNER` | `LE NAM ANH` | Hiện dưới mã QR |
...
Hai hệ dùng chung một tài khoản ngân hàng nhưng khác tiền tố mã đơn — `HOC`
cho hoc.namanhsuit.com, `SCH` cho Scholish. Mỗi endpoint bỏ qua giao dịch
không mang tiền tố của mình, nên cùng nhận mọi giao dịch cũng không giẫm chân.
